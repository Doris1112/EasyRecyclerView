...
package com.luck.easyrecyclerview.adapter;
        ...
        if (mItemClickListener != null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mItemClickListener.onItemClick(viewHolder.getAdapterPosition() - headers.size(), v);
                }
            });
        }
        ...
        if (mItemLongClickListener != null) {
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return mItemLongClickListener.onItemClick(viewHolder.getAdapterPosition() - headers.size(), v);
                }
            });
        }
//        viewHolder.setIsRecyclable(false); //不让其复用
        return viewHolder;
    }
